...
#define Dcst _p[12]
#define Dcst_columnindex 12
#define Dost _p[13]
#define Dost_columnindex 13
#define Dist _p[14]
#define Dist_columnindex 14
#define v _p[15]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kctin /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/kctin.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = ist_columnindex;  _dlist1[0] = Dist_columnindex;
 _slist1[1] = cst_columnindex;  _dlist1[1] = Dcst_columnindex;
 _slist1[2] = ost_columnindex;  _dlist1[2] = Dost_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/kctin.mod";
static const char* nmodl_file_text = 
  "\n"
  "TITLE Kct current\n"
  "\n"
