...
#define nrn_init _nrn_init__IKsin
#define _nrn_initial _nrn_initial__IKsin
#define nrn_cur _nrn_cur__IKsin
#define _nrn_current _nrn_current__IKsin
#define nrn_jacob _nrn_jacob__IKsin
#define nrn_state _nrn_state__IKsin
#define _net_receive _net_receive__IKsin 
#define rate rate__IKsin 
#define states states__IKsin 
...
#define ainf _p[7]
#define ainf_columnindex 7
#define binf _p[8]
#define binf_columnindex 8
#define atau _p[9]
#define atau_columnindex 9
#define btau _p[10]
#define btau_columnindex 10
#define ek _p[11]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_IKsin", _hoc_setdata,
 "rate_IKsin", _hoc_rate,
 0, 0
};
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gKsbar_IKsin", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gKsbar_IKsin", "mho/cm2",
 "ik_IKsin", "mA/cm2",
 "gk_IKsin", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 IKsin /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/IKsin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/IKsin.mod";
static const char* nmodl_file_text = 
