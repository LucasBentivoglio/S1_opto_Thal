...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nax /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/nax_BS.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/nax_BS.mod";
static const char* nmodl_file_text = 
  "TITLE nax\n"
