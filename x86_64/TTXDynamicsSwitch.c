...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "#ttx_ion");
 	...
 	ivoc_help("help ?1 TTXDynamicsSwitch /home/fernando/Dropbox/UEPG_DN/Ultra_Fast_Ripple/S1_opto_Thal/modfiles/TTXDynamicsSwitch.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/fernando/Dropbox/UEPG_DN/Ultra_Fast_Ripple/S1_opto_Thal/modfiles/TTXDynamicsSwitch.mod";
static const char* nmodl_file_text = 
