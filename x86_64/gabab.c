...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 GABAB /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/gabab.mod\n");
...
static int bindkin (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset=0; int error = 0;
 ...
 error = nrn_newton_thread(_newtonspace1, 3,_slist2, _p, bindkin, _dlist2, _ppvar, _thread, _nt);
...
{
 {  _deriv1_advance = 1;
 derivimplicit_thread(3, _slist1, _dlist1, _p, bindkin, _ppvar, _thread, _nt);
_deriv1_advance = 0;
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 3; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/gabab.mod";
static const char* nmodl_file_text = 
