...
#define gmax gmax_DetAMPANMDA
 double gmax = 0.001;
#define mggate_DetAMPANMDA _thread1data[0]
#define mggate _thread[_gth]._pval[0]
 ...
 "mggate_DetAMPANMDA", &mggate_DetAMPANMDA,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 DetAMPANMDA /home/fernando/Dropbox/UEPG_DN/Ultra_Fast_Ripple/S1_opto_Thal/modfiles/DetAMPANMDA.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   mggate = 1.0 / ( 1.0 + exp ( 0.062 * - ( v ) ) * ( mg / 2.62 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/fernando/Dropbox/UEPG_DN/Ultra_Fast_Ripple/S1_opto_Thal/modfiles/DetAMPANMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "/**\n"
