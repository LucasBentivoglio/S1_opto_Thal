...
#define drive_channel _p[3]
#define drive_channel_columnindex 3
#define Dca _p[4]
...
#define cainf cainf_cadyn
 double cainf = 5e-05;
#define depth depth_cadyn
 double depth = 0.1;
#define taur taur_cadyn
 double taur = 200;
 ...
 "taur_cadyn", &taur_cadyn,
 "cainf_cadyn", &cainf_cadyn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadyn /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/cadyn.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   Dca = drive_channel / 18.0 + ( cainf - ca ) / taur * 11.0 ;
   cai = ca ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/cadyn.mod";
static const char* nmodl_file_text = 
