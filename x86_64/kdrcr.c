...
#define nrn_init _nrn_init__kdrcr
#define _nrn_initial _nrn_initial__kdrcr
#define nrn_cur _nrn_cur__kdrcr
#define _nrn_current _nrn_current__kdrcr
#define nrn_jacob _nrn_jacob__kdrcr
#define nrn_state _nrn_state__kdrcr
#define _net_receive _net_receive__kdrcr 
#define rate rate__kdrcr 
#define states states__kdrcr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdrcr", _hoc_setdata,
 "alf_kdrcr", _hoc_alf,
 "bet_kdrcr", _hoc_bet,
 "rate_kdrcr", _hoc_rate,
 0, 0
};
#define alf alf_kdrcr
#define bet bet_kdrcr
 extern double alf( _threadargsprotocomma_ double );
 extern double bet( _threadargsprotocomma_ double );
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gkdrbar_kdrcr", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gkdrbar_kdrcr", "mho/cm2",
 "ik_kdrcr", "mA/cm2",
 "gk_kdrcr", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrcr /home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/kdrcr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/lucas-eduardo-bentivoglio/Music/S1_opto_Thal/mod2/kdrcr.mod";
static const char* nmodl_file_text = 
